...
const Update = () => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:8000/api/pirates/${id}`)
            .then(res => {
                setName(res.data.pirate_name);
                setImgUrl(res.data.image_url);
                setTreasure(res.data.num_of_chests);
                setPhrases(res.data.phrase);
    ...
    <div className='row'>
        ...
        <div className='col-md-6'>
            ...
            <div className='form-group mt-3'>
                <input type="submit" className='btn btn-primary' value="Update Pirate"/>
            </div>
        </div>
    </div>
</form>
